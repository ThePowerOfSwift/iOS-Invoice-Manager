...
- (void)updateSemiSpaDataTable:(OptionsAutoDetailPVC *)optionsVS editType:(NSString*) editType withServiceCell: (ServiceDataCell*) cell_arg;
@end

@interface OptionsAutoDetailPVC : BasePopoverVC {
    
    // delegate variables
    id <OptionsAutoDetailPVCDelegate> SSVCDelegate;  // options view controller delegate
...
@property (nonatomic, assign) id <OptionsAutoDetailPVCDelegate> SSVCDelegate;
